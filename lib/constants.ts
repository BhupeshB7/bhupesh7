...
export const HERO_STATS = [
  { value: "High Performance", label: "Backend Systems" },
  { value: "Secure & Scalable", label: "API Architecture" },
  { value: "System Design", label: "Core Strength" },
  { value: "Ready to Deliver", label: "Work & Freelance" },
] as const;
export const SOCIALS = [
  { label: "GitHub", url: "https://github.com/bhupeshb7", icon: "GH" },
  { label: "LinkedIn", url: "https://linkedin.com/in/bhupeshb7", icon: "LI" },
  { label: "Twitter", url: "https://twitter.com/bhupeshB7", icon: "TW" },
  { label: "Email", url: `mailto:${CONTACT_EMAIL}`, icon: "EM" },
  { label: "Blog", url: "/blog", icon: "BL" },
] as const;
...
export const TECH_STACK = [
  { label: "Node.js", pct: 92, color: "#34d399" },
  { label: "NestJS", pct: 85, color: "#c084fc" },
  { label: "MongoDB / PostgreSQL", pct: 88, color: "#fbbf24" },
  { label: "REST APIs / gRPC", pct: 90, color: "#c084fc" },
  { label: "Redis / Caching / Message Queues", pct: 88, color: "#34d399" },
  { label: "CI/CD", pct: 78, color: "#f97316" },
  { label: "AWS ", pct: 65, color: "#fbbf24" },
] as const;

export const LANGUAGES = [
  { name: "JavaScript", pct: 68, color: "#fbbf24" },
  { name: "TypeScript", pct: 11, color: "#f97316" },
  { name: "JAVA", pct: 10, color: "#c084fc" },
  { name: "Other", pct: 12, color: "rgba(255,255,255,.15)" },
] as const;

export const BUILDING = [
  "Google Drive Clone — file storage & sharing system",
  "Queue Management System — real-time system (Team Lead)",
  "MERN APIs — scalable backend services & auth systems",
] as const;
...
export const ABOUT_BIO = {
  ...
  avatar: "/avatar.jpg",
  tagline:
    "Full Stack Developer building scalable backend systems and production-ready applications.",
  bio: [
    "I'm a Full Stack Developer with 1+ year of hands-on experience building scalable web applications using the MERN stack. I specialize in backend development — designing secure APIs, managing databases, and building high-performance systems.",
    "Currently working as a Full Stack Developer, I have also completed an internship at Edureka where I worked on real-world projects involving API design, database modeling, authentication, and performance optimization.",
    "I focus on system design, clean architecture, and writing maintainable code using SOLID principles and design patterns. I'm actively open to backend roles, freelance projects, and collaborations on impactful products.",
  ],
...
export const JOURNEY = [
  {
    ...
    org: "BITS Pilani",
    desc: "Leading development of a Queue Management System, focusing on scalable backend architecture, real-time updates, and efficient system design for high concurrency environments.",
    tags: ["MERN", "System Design", "Leadership"],
  },
  {
    year: "2025",
    type: "work",
    title: "Full Stack Developer",
    org: "CODING OTT (Startup)",
    desc: "Working as a Full Stack Developer building production-ready applications with Node.js, Express, MongoDB, and React. Developing scalable APIs, authentication systems, and performance-optimized backend services.",
    tags: [
      "Node.js",
      "Express",
      "MongoDB",
  ...
  },
  {
    year: "2025",
    type: "project",
    title: "Cloud storage (Self Project)",
    org: "Personal Project",
    desc: "Building a scalable file storage and sharing system with authentication, access control, file hierarchy, and secure public sharing. Focused on backend architecture, security, and performance.",
    tags: ["MERN", "File System", "Security"],
  },
  {
    year: "2023",
    type: "edu",
    ...
    org: "BITS Pilani",
    desc: "Pursuing Bachelor's in Computer Science & Engg. with strong focus on data structures, system design, backend development, and real-world software engineering practices.",
  ...
  },
  {
    ...
    org: "Independent",
    desc: "Delivered freelance projects including an MLM system and an eCommerce platform. Built complete backend systems, APIs, authentication, and database architecture.",
    tags: ["MERN", "Freelance", "API Development"],
  },
  {
    year: "2022",
    type: "work",
    ...
    org: "Edureka",
    desc: "Completed full stack development internship working on MERN stack. Gained practical experience in API development, database modeling, authentication, and deployment.",
    tags: ["MERN", "Internship", "Backend"],
  },
] as const;
