...
function FooterNavItem({ label, href, icon, external = false }: NavLinkItem) {
  ...
  return (
    <a
      ...
      target={external ? "_blank" : undefined}
      rel={external ? "noopener noreferrer" : undefined}
      className="group relative flex items-center gap-2.5 py-2 text-[13px] transition-all duration-200"
    ...
    >
      ...
      <span className="relative inline-flex leading-none">
        ...
        <span
          ...
          style={{
            width: hovered ? "100%" : "0%",
            background: `linear-gradient(90deg, ${c}70, ${c}20)`,
          }}
        />
      </span>
      {external && (
    ...
    <footer ref={footerRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            (c) {new Date().getFullYear()} {CONTACT.name}
          </span>
          <span
